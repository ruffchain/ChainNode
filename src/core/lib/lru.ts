...
export class LRU {
    ...
    private head: LRUItem | null;
    private tail: LRUItem | null;
    private pending: LRUBatch | null;
    private capacity: number;
    private getSize?: (value: any) => number;
    constructor(capacity: number, getSize?: (value: any) => number) {
    ...
    _insertList(ref: LRUItem | null, item: LRUItem) {
        assert(!item.next);
        assert(!item.prev);
...
class LRUItem {
    public key: string;
    public value: any;
    public next: LRUItem | null;
    public prev: LRUItem | null;
...
class LRUOp {
    ...
    public key: string;
    public value: any;
    constructor(remove: boolean, key: string, value: any) {
        this.remove = remove;
        this.key = key;
        this.value = value;
    }
